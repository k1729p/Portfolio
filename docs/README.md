...
Code checking and refactoring was done with [IntelliJ IDEA](https://www.jetbrains.com/idea/) and GitHub [Copilot](https://github.com/features/copilot) <img src="images/Copilot.png" alt="GitHub Copilot" width="24" height="19">.<br>
